  ...
  return (
    <div className="mx-auto max-w-6xl">
      <div className="mb-8 text-center">
        ...
        <h3 className="text-4xl font-bold text-blue-600 mb-4">DASHBOARD</h3>
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6">
          ...
          <p className="text-blue-100">Total Posts: {posts.length}</p>
        </div>

        <div className="p-6">
          <div className="space-y-4">
            {posts.map((post) => (
              <article key={post.id} className="flex items-start justify-between rounded-xl border-2 border-gray-200 bg-gray-50 p-6 hover:border-blue-300 transition-colors">
                ...
                <button
                  type="button"
                  className="ml-6 bg-rose-600 hover:bg-rose-700 text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg"
